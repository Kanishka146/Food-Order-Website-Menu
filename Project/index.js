...
function displayItems(){
    ...
    var tandoori=  document.getElementById('tandoori');;
    var continental=  document.getElementById('continental');
    var beverages=  document.getElementById('beverages');
    var indiansnacks=  document.getElementById('indian-snacks');
    ...
    const  tandooriData= foodItem.filter((item)=>item.category=='tandoori');
    ...
    const indiansnacksData= foodItem.filter((item)=>item.category=='indian snacks');
    const chineseData= foodItem.filter((item)=>item.category=='c');
    ...
    maincourseData.map(item=>{
        ...
        maincourse.appendChild(itemCard);
        
    })


    tandooriData.map(item=>{
        var itemCard= document.createElement('div');
        itemCard.setAttribute('id','item-card')
    ...
    indiansnacksData.map(item=>{
        ...
        indiansnacks.appendChild(itemCard)
